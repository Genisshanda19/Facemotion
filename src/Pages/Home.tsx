      ...
      <>
        ...
        >
            ...
            <Heading  bgGradient='linear(to-l, #7928CA, #FF0080)' bgClip='text' fontSize='6xl'fontWeight='extrabold'>
                 <h1> Selamat Datang Di Face Motion</h1>
            </Heading>
            <br></br>
            ...
            <Text style={{ textAlign: 'center' , fontFamily: 'Garamond', fontSize: 20 }}> Face Motion adalah aplikasi yang mampu mendeteksi ekspresi wajah. Face Motion dapat mengenali
                 berbagai macam ekspresi emosi, termasuk Marah, Sedih, Bahagia, Netral, Jijik, Takut, dan Terkejut. 
                 ...
                 Selamat menikmati perjalanan emosional Anda bersama Face Motion
            </Text>
                ...
                <Box
                    ...
                    bgGradient="linear(to-tr, teal.300,purple.300, pink.400)"
                    _hover={{
                        bgGradient: "linear(to-r, blue.200, yellow.300, purple.200)",
                    }}
                    >
                    MULAI DETEKSI
                </Box>
